...
class FortniteFixer_v1_5:
    def __init__(self, root):
        self.root = root
        self.is_running = False

        self.root.title("Fortnite Crash Fixer v1.5")
    ...
    def build_ui(self):
        ...
        tk.Label(
            bar,
            text="🎮 Fortnite Crash Fixer v1.5",
            bg="#2c2c2c",
            fg="white",
            font=("Arial", 10, "bold"),
        ...
        ttk.Label(
            self.root,
            text="Version 1.5  |  Not affiliated with Epic Games",
            font=("Arial", 7),
            foreground="gray",
        ).pack(pady=3)
...
=============================
Fortnite Crash Fixer is a diagnostic and repair tool designed to:
...
# Privacy Policy — Fortnite Crash Fixer v1.5
